...
El apartado b consiste en añadir un nuevo tipo de semáforo con tres estados, aprovechando el código del apartado a. Hemos transformado `EstadoBiestable` en la clase abstracta `EstadoSemaforo`, convirtiendo así el patrón estado en un patrón estrategia con 3 estrategias distintas. Las clases `Biestable` y `Triestable` heredan de la clase semáforo y son estas las que contienen el comportamiento para realizar las transiciones de la máquina de estados
## Apartado C
