...
- `activo`/_{Attributes}_: Sirve para calcular el salario como activo del trabajor.
- `pensionista`/_{Attributes}_: Sirve para calcular el salario como pensionista del trabajador.
