...
programación para el lenguaje de programación Java estandarizado, conocido como
...
una serie de test unitarios usando el framework jUnit5[^3].
...
- `put(Pieza pieza)`: Añade a la bandeja la pieza pasada por parámetro si es
  posible
...
- `get(Bandeja bandeja)`/_{Getter}_: Lanza una excepción del
...
- `get(Bandeja bandeja)`/_{Getter}_: Dada la bandeja por parámetro, devuelve la
  primera pieza dentro de la lista de piezas.
- `put(Pieza pieza, Bandeja bandeja)`/_{Setter}_: Lanza una excepción del
